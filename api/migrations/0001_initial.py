# Generated by Django 4.1.5 on 2023-03-24 19:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('groups', models.ManyToManyField(blank=True, related_name='platform_user_set', to='auth.group')),
                ('platform', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.platform')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='platform_user_set', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='usertoken', to='api.platformuser')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.platformuser')),
